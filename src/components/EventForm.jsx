...
const EventForm = () => {
  ...
  return(
    ...
    <form>
      ...
      <button className="btn btn-danger" onClick={deleteAllEvent} disabled={state.events.length === 0} >全てのイベントを削除</button>
